        ...
        <App title="LuxJS Demo #1">
            <NavView sideBar={useSideBar ? {
                ...
                },
                {
                    label: "Home",
                    iconFillSpace: true,
                    icon: <img src="https://c.tenor.com/COwudY0PrCcAAAAd/discord-logo-discord.gif" />
                },
                {
                    label: "GitHub",
                    iconFillSpace: true,
